function [length, varargout] = algoInverseKinematics_FiniteSegment(Pose, PulleyPositions, CableAttachments, Wrench, CableForceLimits, CableProperties, GravityConstant)
%#codegen
% ALGOINVERSEKINEMATICS_FINITESEGMENT - Perform inverse kinematics for the given
%   pose of the virtual robot using a finite segment approach
%   
...
% 
%   LENGTH = ALGOINVERSEKINEMATICS_FINITESEGMENT(POSE, PULLEYPOSITIONS, CABLEATTACHMENTS)
%   performs simple inverse kinematics with the cables running from a_i to
%   b_i for the given pose
% 
%   [LENGTH, CABLEVECTORS] = ALGOINVERSEKINEMATICS_FINITESEGMENT(...) also provides the
%   vectors of the cable directions from platform to attachment point given
%   in the global coordinate system
% 
%   [LENGTH, CABLEVECTORS, CABLEUNITVECTORS] = ALGOINVERSEKINEMATICS_FINITESEGMENT(...)
