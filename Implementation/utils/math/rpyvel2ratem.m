...
% aPInvDot_Temp = cat(1 ...
%     , vZeros,   -vOneDot.*vSinTwo.*vCosThree,   -vOneDot.*vCosTwo.*vSinThree + vTwoDot.*vCosThree...
%     , vZeros,    vOneDot.*vSinTwo.*vSinThree,   -vOneDot.*vCosTwo.*vCosThree - vTwoDot.*vSinThree ...
%     , vZeros,    vOneDot*vCosTwo,                vZeros ...
% );
aPInvDot_Temp = cat(1 ...
    , vZeros,   -vOneDot.*vSinTwo.*vCosThree,   -vOneDot.*vCosTwo.*vSinThree - vTwoDot.*vCosThree...
    , vZeros,   -vOneDot.*vSinTwo.*vSinThree,    vOneDot.*vCosTwo.*vCosThree - vTwoDot.*vSinThree ...
