...
%
%   COLL = COGIRO_IMPORTCONTROL(FILENAME) imports control command information
%   stored in FILENAME and puts it into timeseries collection COLL.
%
%   COLL = COGIRO_IMPORTCONTROL(FILENAME, SAMPLING) imports with specified
%   sampling time rather than guessed from the control system data.
%
%   COLL = COGIRO_IMPORTCONTROL(FILENAME, 'Name', 'Value', ...) imports control
%   command information in FILENAME with additional options specified by one or
