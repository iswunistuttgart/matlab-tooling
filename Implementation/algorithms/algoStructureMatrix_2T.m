function StructureMatrix = algoStructureMatrix_2T(CableAttachments, CableVectors)%#codegen
% ALGOSTRUCTUREMATRIX_2T - Calculate the structure matrix for the given cable
%   attachment points and cable vectors of a 3T cable robot
% 
%   STRUCTUREMATRIX = ALGOSTRUCTUREMATRIX_2T(CABLEATTACHMENTS, CABLEVECTORS)
...
%
%   [STRUCTUREMATRIX, NULLSPACE] = ALGOSTRUCTUREMATRIX_2T(...) also returns
