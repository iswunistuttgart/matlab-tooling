...
%   9.81[kg m/s^2]
% 
%   SHAPE = ALGOCABLESHAPE_CATENARY(..., GRAVITYCONSTANT) draws the same cable
%   shape as before but now considers GRAVITYCONSTANT in [kg m/^2] as the
%   gravity constant
% 
%   SHAPE = ALGOCABLESHAPE_CATENARY(..., DISCRETIZATIONPOINTS) draws the same
%   cable shape as before but now spreads DISCRETIZATIONPOINTS points over the
%   length discretizing it more or less precisley
%   
%   
%   Inputs:
%   
