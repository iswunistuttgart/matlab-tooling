function StructureMatrix = algoStructureMatrix_3T(CableAttachments, CableVectors)%#codegen
% ALGOSTRUCTUREMATRIX_3T - Calculate the structure matrix for the given cable
...
%
%   [STRUCTUREMATRIX, NULLSPACE] = ALGOSTRUCTUREMATRIX_3T(...) also returns
