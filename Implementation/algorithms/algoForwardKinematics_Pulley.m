...
%   kinematics
% 
%   POSE = ALGOFORWARDKINEMATICS_PULLEY(CABLELENGTH, PULLEYPOSITION,
...
vLengths = algoInverseKinematics_Pulley(vEstimatedPose, aPulleyPosition, aCableAttachment, vPulleyRadius, aPulleyOrientation);
...
if nargout > 1
    ...
    for iCable = 1:nNumberOfCables
        ...
        aPulleyRotation = rotz(aPulleyOrientation(3,iCable))*roty(aPulleyOrientation(2,iCable))*rotx(aPulleyOrientation(1,iCable));
