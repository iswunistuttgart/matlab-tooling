...
% Stretch the cable length because it is an elastic catenary
dCableLength = dCableLength ...
    + 1./(2*dCablePropDensity*dGravityConstant*dCablePropYoungsModulus*dCablePropUnstrainedSection)*( 0 + ...
        + dCableForceZ*sqrt(dCableForceX.^2 + dCableForceZ.^2) + ...
        + dCableForceX.^2*asinh(dCableForceZ./abs(dCableForceX)) + ...
        - (dCableForceZ - dCablePropDensity*dGravityConstant*dCableLength)*sqrt(dCableForceX.^2 + (dCableForceZ - dCablePropDensity*dGravityConstant*dCableLength).^2) + ...
        - dCableForceX.^2*asinh((dCableForceZ - dCablePropDensity*dGravityConstant*dCableLength)./abs(dCableForceX))...
    );
