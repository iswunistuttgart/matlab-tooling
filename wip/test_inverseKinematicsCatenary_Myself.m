...
vInitForceDistribution = algoForceDistribution_AdvancedClosedForm([Robot.Environment.ForceFieldDirection.*Robot.Environment.GravitationalConstant; 0; 0; 0], getStructureMatrix('3R3T', Robot.Platform.Anchor.Position, aCableUnitVector), 100, 3000);
