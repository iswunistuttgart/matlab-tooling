function o = daeget(options,name,default,flag)
%DAEGET Get DAE OPTIONS parameters.
%   VAL = DAEGET(OPTIONS,'NAME') extracts the value of the named property
