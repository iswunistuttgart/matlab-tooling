...
%   OPTIONS = DAESET('NAME1',VALUE1,'NAME2',VALUE2,...) creates an integrator
...
%   
%   OPTIONS = DAESET(OLDOPTS,'NAME1',VALUE1,...) alters an existing options
%   structure OLDOPTS.
%   
%   OPTIONS = DAESET(OLDOPTS,NEWOPTS) combines an existing options structure
%   OLDOPTS with a new options structure NEWOPTS. Any new properties
%   overwrite corresponding old properties. 
%   
%   DAESET with no input arguments displays all property names and their
%   possible values.
%   
%DAESET PROPERTIES
%   
...
if (nargin == 0) && (nargout == 0)
  ...
  fprintf('    ConstraintsQ: [ function_handle ]\n');
  fprintf('   JConstraintsQ: [ function_handle ]\n');
  fprintf('   ConstraintsDQ: [ function_handle ]\n');
  fprintf('  JConstraintsDQ: [ function_handle ]\n');
  fprintf('\n');
  return;
end
...
% Combine all leading options structures o1, o2, ... in daeset(o1,o2,...).
options = [];
for j = 1:m
